...
public class TestCase_35804 extends TestUtils
{
	@Test
	@Parameters("browser")
	public void Filter_LL_Value_By_Entry_Enter_FIRST_element_name_in_the_filter_from_the_list(String browser) throws Exception
	{
		test =extent.createTest("TestCase_35804: Filter_LL_Value By Entry_Enter FIRST element name in the filter from the list");
		Login log = new Login();
		...
		Thread.sleep(1000);
		//span[text()='Acura']
		NoOfFilterSrchElmt.get(1).click();
		Thread.sleep(1000);
		...
		Assert.assertTrue(filterselval.equals("Acura"));		
