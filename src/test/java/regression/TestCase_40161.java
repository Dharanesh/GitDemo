...
public class TestCase_40161 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	    System.out.println("40161---Test Task started........");
		//login to the application:==========
	  	test =extent.createTest("Test Task 40161: Test Case 28788: 14175 : Cockpit DataView Olap Functions for ClientRules_SumOfElems");
	  	log = new Login();
	  	...
	  	System.out.println("==Test Task 40161: Test Case 28788: 14175 : Cockpit DataView Olap Functions for ClientRules_SumOfElems==");
	  	Thread.sleep(3000);
		...
		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).clear();
  		Thread.sleep(1000);
  		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("ClientRules_SumOfElems_check");;
  		Thread.sleep(1000);
		...
		Thread.sleep(5000);
  		...
  		//Click On Measure and element grp:====
		...
		for(int i=0;i<ClientRules.size();i++)
		{
			...
			if(ClientRules.get(i).getText().equals("SumOfElemsColumns"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='SumOfElemsColumns']")).click();
				Thread.sleep(2000);
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("SumOfElemsColumns");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
	    
		String SumFormula="SumOfElems("+"\""+"A - Training Sales.[Measures]"+"\","+" "+"\""+"Purchase price"+"\","+"\""+"Repairs"+"\","+"\""+"Units purchased"+"\")";
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='SumOfElemsColumns']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Calculated element check boxs are unchecked.");
		 Thread.sleep(1000);
		
		 //Rank Ascending element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='SumOfElemsColumns']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("SumOfElemsColumns text is displaying now..");
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='SumOfElemsColumns']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("SumOfElemsColumns checkbox is unchecked..");
		 log.driver.findElement(By.xpath("//div[text()='SumOfElemsColumns']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 ...
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='SumOfElemsColumns']")).isDisplayed());
		 Thread.sleep(1000);
		 System.out.println("Client Rule is displaying as Column");
		...
		//Save As:===============
			...
			Thread.sleep(2000);
			log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("ClientRules_SumOfElems");
			Thread.sleep(2000);
			...
			//Delete Report:==================
			log.driver.findElement(By.xpath("(//span[text()='ClientRules_SumOfElems'])[3]")).click();
			Thread.sleep(3000);
			act.contextClick(log.driver.findElement(By.xpath("(//span[text()='ClientRules_SumOfElems'])[1]"))).perform();
			Thread.sleep(2000);
