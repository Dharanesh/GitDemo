...
public class TestCase_28781 extends TestUtils
{
	@Test	
	@Parameters("browser")

	public void Cockpit_DataView_Olap_Functions_ClientRules_DimIsChild(String browser) throws Exception
	{
	    test =extent.createTest("TestCase_28781: Cockpit DataView Olap Functions for ClientRules_DimIsChild");
		Login log = new Login();
		...
		log.createCubeReport("//div[text()='A - Training Sales']","ClientRules_DimIsChild_check",true);
		...
		for(int i=0;i<=basevalueaftupdate.size()-1;i++) 
		{
			...
			System.out.println("2014 value is checked");
		}
		...
		WebElement we=log.driver.findElement(By.xpath("//button[text()='Element Groups...']/following::div[2]/span/span[1]/span[1]"));
		Actions a1=new Actions(log.driver);
		a1.click(we).sendKeys("B - Training Sales", Keys.ENTER).build().perform();
		Thread.sleep(2000);
		...
		assertEquals(log.driver.findElement(By.xpath("//button[text()='Element Groups...']/following::div[2]/span/span[1]/span[1]")).getText(), "B - Training Sales");
		System.out.println("B - Training Sales is selected in drop down");
		
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='Units sold']");
		log.driver.findElement(By.xpath("//div[text()='Units sold']")).click();
		Thread.sleep(2000);
       ...
       try{
			for(int i=0;i<=SelectableElementvalue.size()-1;i++)
			{
				...
				if(valueofcontainerele.contains("DimIsChild"))
				{
					System.out.println("DimIsChild is present");
					test.info("DimIsChild is present");
					
					waits.waitUntil_Elmentis_visibilityOfElement(10,"//span[text()='DimIsChild']");
					log.driver.findElement(By.xpath("//span[text()='DimIsChild']")).click();
					Thread.sleep(1000);
		...
		log.driver.findElement(By.xpath("//span[text()='Name:']/ancestor::div[3]/div[2]//input[1]")).sendKeys("DimIsChild");
		Thread.sleep(500);
		...
		action.click();
		//string s="DimIsChild( "A - Training Sales.[Time].[Time]","1 2013","2014")"
		action.sendKeys("DimIsChild( \"A - Training Sales.[Time].[Time]\",\"1 2013\",\"2014\")");
		...
		for (int i =0;i<=selectble_ele.size()-1;i++) 
		{
			...
			selectable.add(aa);
			if(selectable.contains("DimIsChild"))
			{
				assertTrue(true);
				System.out.println("DimIsChild is available");
				
			}
			
		}
		Thread.sleep(2000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='DimIsChild']/../div[1]");
		log.driver.findElement(By.xpath("//div[text()='DimIsChild']/../div[1]")).click();
		Thread.sleep(1000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='DimIsChild']/../div[1]");
		assertTrue(log.driver.findElement(By.xpath("//div[text()='DimIsChild']/../div[1]/input[1]")).isSelected());
		System.out.println("DimIsChild Checkbox is Selected in the list of selectable elements");
		...
		waits.waitUntil_Elmentis_visibilityOfElement(10,"(//div[text()='2014'])[1]/ancestor::div[3]/div[3]/div/div");
		List<WebElement> TableColumnHdr = log.driver.findElements(By.xpath("(//div[text()='2014'])[1]/ancestor::div[3]/div[3]/div/div"));
		for (WebElement webElement : TableColumnHdr)
		{
			if(webElement.getText().equals("Units sold")||webElement.getText().equals("DimIsChild"))
			{
				assertTrue(true);
			}
		}
		...
		System.out.println("column with the name Units sold and DimIsChild");
		test.info("column with the name Units sold and DimIsChild");
		
		String text=log.driver.findElement(By.xpath("//div[text()='2014']/ancestor::div[4]/div/div[4]/div/div/div[2]")).getText();
		...
		List<WebElement> AB12 = log.driver.findElements(By.xpath("//span[contains(text(),'Selection for Rows')]/ancestor::div[2]/div[2]/div[2]/div[1]/input"));
		for (WebElement btn : AB12)
		{
			Thread.sleep(100);
			assertTrue(btn.isEnabled());
			System.out.println(btn.getAttribute("value") + "    is displayed and Enabled");
		...
		{
			assertEquals(Group1.get(i).getText(), groupValue.get(i));
		...
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//span[text()='Element Groups']/following::div[5]/div[5]/div/div/button");
		List<WebElement> grpEleBtn12= log.driver.findElements(By.xpath("//span[text()='Element Groups']/following::div[5]/div[5]/div/div/button"));
		for(int i =0;i<=grpEleBtn12.size()-1;i++) 
		{
			String value1 = grpEleBtn12.get(i).getCssValue("disabled");
			System.out.println(value1);

			if(value1.contains("true"))
			{
				System.out.println(grpEleBtn12.get(i).getText());
				test.info(grpEleBtn12.get(i).getText()+"button disabled");
				Thread.sleep(2000);
			}
			...
			else
			{
				System.out.println("Options are not greyedout");
				System.out.println(grpEleBtn12.get(i).getText());
				test.info(grpEleBtn12.get(i).getText()+"button not disabled");
				Thread.sleep(2000);
			}
		...
		Thread.sleep(2000);
		List<WebElement> AB21 = log.driver.findElements(By.xpath("//span[contains(text(),'Element Groups')]/ancestor::div[2]/div[2]/div[2]/div[1]/input"));
		for (WebElement btn : AB21)
		{
			Thread.sleep(100);
			assertTrue(btn.isEnabled());
			System.out.println(btn.getAttribute("value") + "    is displayed and Enabled");
       ...
       try{
			for(int i=0;i<=SelectableElementvalue1.size()-1;i++)
			{
				...
				if(valueofcontainerele.contains("DimIsChild2"))
				{
					System.out.println("DimIsChild2 is present");
					test.info("DimIsChild2 is present");
					
					waits.waitUntil_Elmentis_visibilityOfElement(10,"//span[text()='DimIsChild2']");
					log.driver.findElement(By.xpath("//span[text()='DimIsChild2']")).click();
					Thread.sleep(1000);
					waits.waitUntil_Elmentis_visibilityOfElement(10,"//button[text()='Delete']");
					log.driver.findElement(By.xpath("//button[text()='Delete']")).click();
					Thread.sleep(1000);
		...
		log.driver.findElement(By.xpath("//span[text()='Name:']/ancestor::div[3]/div[2]//input[1]")).sendKeys("DimIsChild2");
		Thread.sleep(1000);
		...
		action.moveToElement(log.driver.findElement(By.xpath("//span[text()='Edit Client Rule']/following::textarea[2]")));
		action.click();
		//string s="DimIsChild( \"A - Training Sales.[Time].[Time]\",\"Q1 2014\",\"2014\")"
		action.sendKeys("DimIsChild( \"A - Training Sales.[Time].[Time]\",\"Q1 2014\",\"2014\")");
		action.build().perform();
		Thread.sleep(2000);
		...
		action.click(elemnt1).sendKeys("Client Rules", Keys.ENTER).build().perform();
		Thread.sleep(2000);
		...
		for (int i =0;i<=selectble_ele1.size()-1;i++) 
		{
			...
			selectable1.add(aa);
			if(selectable1.contains("DimIsChild2"))
			{
				assertTrue(true);
				System.out.println("DimIsChild2 is available");
				
			}
			
		}
		Thread.sleep(2000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='DimIsChild2']/../div[1]");
		log.driver.findElement(By.xpath("//div[text()='DimIsChild2']/../div[1]")).click();
		Thread.sleep(1000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='DimIsChild2']/../div[1]");
		assertTrue(log.driver.findElement(By.xpath("//div[text()='DimIsChild2']/../div[1]/input[1]")).isSelected());
		System.out.println("DimIsChild2 Checkbox is Selected in the list of selectable elements");
		...
		waits.waitUntil_Elmentis_visibilityOfElement(10,"(//div[text()='DimIsChild2'])[1]");
		log.driver.findElement(By.xpath("(//div[text()='DimIsChild2'])[1]")).click();
		Thread.sleep(1000);
		...
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::div[4]/input")).sendKeys("IsChildElement?");
		...
		waits.waitUntil_Elmentis_visibilityOfElement(10,"(//div[text()='2014'])[1]/ancestor::div[3]/div[3]/div/div");
		List<WebElement> TableColumnHdr1 = log.driver.findElements(By.xpath("(//div[text()='2014'])[1]/ancestor::div[3]/div[3]/div/div"));
		for (WebElement webElement : TableColumnHdr1)
		{
			if(webElement.getText().equals("Units sold")||webElement.getText().equals("DimIsChild")||webElement.getText().equals("IsChildElement?"))
			{
				assertTrue(true);
			}
		}
		...
		System.out.println("column with the name Units sold and IsChildElement?");
		test.info("column with the name Units sold and IsChildElement?");
		
		
		String text1=log.driver.findElement(By.xpath("//div[text()='2014']/ancestor::div[4]/div/div[4]/div/div/div[3]")).getText();
		assertTrue(text1.contains("1"));
		System.out.println("showing the value"+text1);
		test.info("showing the value"+text1);
