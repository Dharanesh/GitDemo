...
public class TestCase_40336 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	    System.out.println("40336---Test Task started........");
		//login to the application:==========
	  	test =extent.createTest("Test Task 40336: Test Case 28769: 14194 : Cockpit DataView Olap Functions for ClientRules_ExistSubsetElem");
	  	log = new Login();
	  	...
	  	System.out.println("==Test Task 40336: Test Case 28769: 14194 : Cockpit DataView Olap Functions for ClientRules_ExistSubsetElem==");
	  	Thread.sleep(3000); 
	  ...
	  //Validate New Report window Elements:=============
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("ClientRules_ExistSubsetElem_check");;
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//button[@data-id='30424']")).click();
		Thread.sleep(2000);
		...
		//Click on measure and select Purchase price:=====
		...
		for(int i=0;i<ClientRules.size();i++)
		{
			...
			if(ClientRules.get(i).getText().equals("ExistSubsetElem_40336"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='ExistSubsetElem_40336']")).click();
				Thread.sleep(2000);
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("ExistSubsetElem_40336");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
	  
		String SumFormula="ExistSubsetElem("+"\""+"A - Training Sales.[Products].[Product]"+"\","+"\""+"Product.Manufacturer"+"\","+"\""+"Fia"+"\")";
  	...
  	//Check Syntax:============
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem_40336']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Client Rule check box are unchecked.");
		 Thread.sleep(1000);
				
		 //Rank Ascending element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem_40336']")).isDisplayed());
		 Thread.sleep(2000);
		 ...
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem_40336']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("ExistSubsetElem_40336 client rule is unchecked..");
		 log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem_40336']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("//button[@data-id='30157']")).click();
		 Thread.sleep(2000);
		 ...
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem_40336']")).isDisplayed());
		 Thread.sleep(1000);
		 System.out.println("Client Rule(ExistSubsetElem_40336) is displaying as Column");
		 Thread.sleep(1000);
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("(//div[text()='0.00'])[1]")).isDisplayed());
		 Thread.sleep(1000);
		 System.out.println("Displaying value properly.");
		 Thread.sleep(1000);
		 
		 //Again Create same rule with different element and change property alias name:=============
		 log.driver.findElement(By.xpath("//span[text()='Columns']/following::span[7]/span[2]")).click();
		 Thread.sleep(1000);
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//span[contains(text(),'Selection for Columns')]")).isDisplayed());
		 Thread.sleep(2000);
		 ...
		 for(int i=0;i<ClientRules3.size();i++)
		 {
			...
			if(ClientRules3.get(i).getText().equals("ExistSubsetElem1_40336"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='ExistSubsetElem1_40336']")).click();
				Thread.sleep(2000);
				log.driver.findElement(By.xpath("//button[text()='Delete']")).click();
				Thread.sleep(2000);
				log.driver.findElement(By.xpath("//input[@value='Yes']")).click();
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("ExistSubsetElem1_40336");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
		    
		String SumFormula2="ExistSubsetElem("+"\""+"A - Training Sales.[Products].[Product]"+"\","+"\""+"Product.Manufacturer"+"\","+"\""+"Fiat"+"\" )";
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem1_40336']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Client Rule check box are unchecked.");
		 Thread.sleep(1000);
				
		 //Rank Ascending element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem1_40336']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("ExistSubsetElem1_40336 client rule is displaying now..");
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem1_40336']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("ExistSubsetElem1_40336 client rule is unchecked..");
		 Thread.sleep(1000);
		 log.driver.findElement(By.xpath("//div[text()='ExistSubsetElem1_40336']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("//button[@data-id='30157']")).click();
		 Thread.sleep(2000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::input[1]")).sendKeys("ExistSubsetElem1_40336_Alias");
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("(//div[text()='1.00'])[1]")).isDisplayed());
		 Thread.sleep(1000);
		 System.out.println("Displaying 2nd column value properly.");
		 Thread.sleep(1000);
