...
public class TestCase_40341 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	    System.out.println("40341---Test Task started........");
		//login to the application:==========
	  	test =extent.createTest("Test Task 40341: Test Case 28761: 14199 : Cockpit DataView Olap Functions for ClientRules_CalcElems");
	  	log = new Login();
	  	...
	  	System.out.println("==Test Task 40341: Test Case 28761: 14199 : Cockpit DataView Olap Functions for ClientRules_CalcElems==");
	  	Thread.sleep(3000);  
	  ...
	  //Validate New Report window Elements:=============
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("ClientRules_CalcElems_check");;
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		System.out.println("New Report is created for  client rule ClientRules_CalcElems_check.");
		Thread.sleep(3000);
		...
		for(int i=0;i<ClientRules2.size();i++)
		{
			...
			if(ClientRules2.get(i).getText().equals("CalcElems_40341"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='CalcElems_40341']")).click();
				Thread.sleep(2000);
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("CalcElems_40341");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
	    
	   // CalcElems( "A - Training Sales.[Time].[Time]", 2,"2013","2014","2015")
		String SumFormula="CalcElems("+"\""+"A - Training Sales.[Time].[Time]"+"\","+2+","+"\""+"2013"+"\","+"\""+"2014"+"\","+"\""+"2015"+"\")";
       ...
       //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='CalcElems_40341']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Client Rule check box are unchecked.");
		 Thread.sleep(1000);
						
		 //Rank Ascending element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='CalcElems_40341']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("CalcElems_40341 client rule is displaying now..");
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='CalcElems_40341']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("CalcElems_40341 client rule is unchecked..");
		 Thread.sleep(1000);
		 log.driver.findElement(By.xpath("//div[text()='CalcElems_40341']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("//button[@data-id='30157']")).click();
		 Thread.sleep(2000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::input[1]")).sendKeys("Max Value of Year");
		Thread.sleep(1000);
		...
		Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='Max Value of Year']")).isDisplayed());
		Thread.sleep(1000);
		System.out.println("Client Rule(Max Value of Year) is displaying as Column");
 		
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("(//div[text()='199,947,144.20'])[1]")).isDisplayed());
		 Thread.sleep(1000);
		...
		//Save As The Report:=====
		 ...
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("ClientRules_CalcElems");
		 Thread.sleep(2000);
		...
		//Delete Report:==================
		log.driver.findElement(By.xpath("(//span[text()='ClientRules_CalcElems'])[3]")).click();
		Thread.sleep(3000);
		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='ClientRules_CalcElems'])[1]"))).perform();
		Thread.sleep(2000);
