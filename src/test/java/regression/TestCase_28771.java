...
public class TestCase_28771 extends TestUtils
{
	@Test	
	@Parameters("browser")
	public void Cockpit_DataView_Olap_Functions_ClientRules_CountSDLElems(String browser) throws Exception
	{
	    test =extent.createTest("TestCase_28771: Cockpit DataView Olap Functions for ClientRules_CountSDLElems");
		Login log = new Login();
		...
		log.createCubeReport("//div[text()='A - Training Sales']","ClientRules_CountSDLElems_check",true);
       ...
       try{
			for(int i=0;i<=SelectableElementvalue.size()-1;i++)
			{
				...
				if(valueofcontainerele.contains("Muster - Exoten"))
				{
					System.out.println("Muster - Exoten is present");
					test.info("Muster - Exoten is present");
					
					waits.waitUntil_Elmentis_visibilityOfElement(10,"//span[text()='Muster - Exoten']");
					log.driver.findElement(By.xpath("//span[text()='Muster - Exoten']")).click();
					Thread.sleep(1000);
	    ...
	    log.driver.findElement(By.xpath("//span[.='Name']/ancestor::div[3]/div[2]/div/div/input")).sendKeys("Muster - Exoten");
	    Thread.sleep(2000);
		...
		for (int i =0;i<=selectble_ele1.size()-1;i++) 
		{
			...
			selectable1.add(aa);
			if(selectable1.contains("Muster - Exoten"))
			{
				assertTrue(true);
				Thread.sleep(2000);
		...
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='Muster - Exoten']/../div[1]");
		log.driver.findElement(By.xpath("//div[text()='Muster - Exoten']/../div[1]")).click();
		Thread.sleep(2000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='Muster - Exoten']/../div[1]");
		assertTrue(log.driver.findElement(By.xpath("//div[text()='Muster - Exoten']/../div[1]/input[1]")).isSelected());
		System.out.println("Muster - Exoten Checkbox is Selected in the list of selectable elements");
       ...
       try{
			for(int i=0;i<=SelectableElementvalue1.size()-1;i++)
			{
				...
				if(valueofcontainerele.contains("CountSDLElems"))
				{
					System.out.println("CountSDLElems is present");
					test.info("CountSDLElems is present");
					
					waits.waitUntil_Elmentis_visibilityOfElement(10,"//span[text()='CountSDLElems']");
					log.driver.findElement(By.xpath("//span[text()='CountSDLElems']")).click();
					Thread.sleep(1000);
					waits.waitUntil_Elmentis_visibilityOfElement(10,"//button[text()='Delete']");
					log.driver.findElement(By.xpath("//button[text()='Delete']")).click();
					Thread.sleep(1000);
		...
		log.driver.findElement(By.xpath("//span[text()='Name:']/ancestor::div[3]/div[2]//input[1]")).sendKeys("CountSDLElems");
		Thread.sleep(500);
		...
		action.click();
		//string s="CountSDLElems( "A - Training Sales.[Products].[Product]","Muster - Exoten")"
		action.sendKeys("CountSDLElems( \"A - Training Sales.[Products].[Product]\",\"Muster - Exoten\" )");
		...
		for (int i =0;i<=selectble_ele.size()-1;i++) 
		{
			...
			selectable.add(aa);
			if(selectable.contains("CountSDLElems"))
			{
				assertTrue(true);
				System.out.println("CountSDLElems is available");
				
			}
			
		}
		Thread.sleep(2000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='CountSDLElems']/../div[1]");
		log.driver.findElement(By.xpath("//div[text()='CountSDLElems']/../div[1]")).click();
		Thread.sleep(1000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='CountSDLElems']/../div[1]");
		assertTrue(log.driver.findElement(By.xpath("//div[text()='CountSDLElems']/../div[1]/input[1]")).isSelected());
		System.out.println("CountSDLElems Checkbox is Selected in the list of selectable elements");
		...
		waits.waitUntil_Elmentis_visibilityOfElement(10,"(//div[text()='CountSDLElems'])[2]");
		log.driver.findElement(By.xpath("(//div[text()='CountSDLElems'])[2]")).click();
		Thread.sleep(1000);
		...
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::div[4]/input")).sendKeys("SDLElementCount");
		...
		{
			if(webElement.getText().equals("Purchase price")||webElement.getText().equals("SDLElementCount"))
			{
				assertTrue(true);
			}
		}
		...
		System.out.println("column with the name SDLElementCount");
		test.info("column with the name SDLElementCount");
		...
		{
			if(webElement.getText().equals("10.0"))
			{
				assertTrue(true);
			}
		}
