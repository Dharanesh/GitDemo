...
public class TestCase_40168 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	  	System.out.println("40168---Test Task started........");
		//login to the application:==========
	  	test =extent.createTest("Test Task 40168: Test Case 28780: 14182 : Cockpit DataView Olap Functions for ClientRules_DimChildCount");
	  	log = new Login();
	  	...
	  	System.out.println("==Test Task 40168: Test Case 28780: 14182 : Cockpit DataView Olap Functions for ClientRules_DimChildCount==");
	  	Thread.sleep(3000);
	  ...
	  //Validate New Report window Elements:=============
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("ClientRules_DimChildCount_check");;
		Thread.sleep(1000);
		...
		for(int i=0;i<ClientRules.size();i++)
		{
			...
			if(ClientRules.get(i).getText().equals("DimChildCount_40168"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='DimChildCount_40168']")).click();
				Thread.sleep(2000);
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("DimChildCount_40168");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
	    
	   // DimChildCount( "A - Training Sales.[Products].[Product]", "Acura" )
	    
		String SumFormula="DimChildCount("+"\""+"A - Training Sales.[Products].[Product]"+"\","+" "+"\""+"Acura"+"\""+")";
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='DimChildCount_40168']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Client Rule check box are unchecked.");
		 Thread.sleep(1000);
						
		 //Client rule element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='DimChildCount_40168']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("DimChildCount_40168 client rule is displaying now..");
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='DimChildCount_40168']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("DimChildCount_40168 client rule is unchecked..");
		 log.driver.findElement(By.xpath("//div[text()='DimChildCount_40168']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("//button[@data-id='30157']")).click();
		 Thread.sleep(2000);
		 ...
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='DimChildCount_40168']")).isDisplayed());
		 Thread.sleep(1000);
		 System.out.println("Client Rule(DimChildCount_40168) is displaying as Column");
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("(//div[text()='DimChildCount_40168']/preceding::div[1])[1]")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::input[1]")).sendKeys("DimChildCount_40168_Alias");
		Thread.sleep(1000);
		...
		Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='DimChildCount_40168_Alias']")).isDisplayed());
		Thread.sleep(1000);
		System.out.println("Client Rule(DimChildCount_40168) is displaying as Column");
		 ...
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("ClientRules_DimChildCount");
		 Thread.sleep(2000);
		...
		//Delete Report:==================
		log.driver.findElement(By.xpath("(//span[text()='ClientRules_DimChildCount'])[3]")).click();
		Thread.sleep(3000);
		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='ClientRules_DimChildCount'])[1]"))).perform();
		Thread.sleep(2000);
