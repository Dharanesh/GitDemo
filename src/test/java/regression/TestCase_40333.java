...
public class TestCase_40333 extends TestUtils
{
	...
	{
	    test =extent.createTest("TestCase_28766:  Cockpit DataView Olap Functions for ClientRules_ExistDimElem");
		Login log = new Login();
		...
		log.createCubeReport("//div[contains(text(),'Training Sales')]", "TestCase_28766", false);
//		Client rule 
		...
		// remove timetype from row
				WebElement from = log.driver.findElement(By.xpath("(//span[text()='Product'])[2]"));
		...
		Thread.sleep(200);
		wait.waituUnitil_Element_Clickable(20,"(//div[text()='Purchase price'])[1]");
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("(//div[text()='Purchase price'])[1]")).click();
		...
		{
			Thread.sleep(5000);
			if(ele.get(i).getText().equalsIgnoreCase("ExistDimElem")) 
			{
				ele.get(i).click();
				Thread.sleep(2000);
		...
		log.driver.findElement(By.xpath("//div[@class='w20_webedit']/div/input[1]")).sendKeys("ExistDimElem");
		wait.waituUnitil_Element_Clickable(20,"//button[text()='Check Syntax']");
		...
		act.sendKeys(exl.ExcelDatainput("UAT", 15, 1)).perform();
		...
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("(//input[@value='OK'])[1]")).click();
		wait.waituUnitil_Element_Clickable(20,"//span[text()='ExistDimElem']");
		log.driver.findElement(By.xpath("(//input[@value='OK'])[1]")).click();
		...
		wait.waituUnitil_Element_Clickable(20,"//div[text()='ExistDimElem']");
		log.driver.findElement(By.xpath("//div[text()='ExistDimElem']")).click();
		Thread.sleep(2000);
		wait.waituUnitil_Element_Clickable(20,"//span[contains(text(),'2 Items')]");
		log.driver.findElement(By.cssSelector("#okbutton")).click();
		Thread.sleep(2000);
		assertEquals(log.driver.findElement(By.xpath("//div[@id='1/-1']")).getText(), "ExistDimElem");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("(//*[text()='ExistDimElem'])[1]/../div[1]")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(200);
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::input[1]")).sendKeys("Dimension Element Aud Exists or not");
		Thread.sleep(200);
		...
		Thread.sleep(3000);
		assertEquals(log.driver.findElement(By.xpath("//div[@id='1/-1']")).getText(), "Dimension Element Aud Exists or not");
		Thread.sleep(3000);
		assertEquals(log.driver.findElement(By.xpath("//div[@id='1/0']")).getText(), "0.00");
		log.driver.close();
