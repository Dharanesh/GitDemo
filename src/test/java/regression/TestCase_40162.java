...
public class TestCase_40162 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	  System.out.println("40162---Test Task started........");
		//login to the application:==========
	  	test =extent.createTest("Test Task 40162: Test Case 28778: 14176 : Cockpit DataView Olap Functions for ClientRules_Getvalue");
	  	log = new Login();
	  	...
	  	System.out.println("==Test Task 40162: Test Case 28778: 14176 : Cockpit DataView Olap Functions for ClientRules_Getvalue==");
	  	Thread.sleep(3000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("ClientRules_Getvalue_check");;
		Thread.sleep(1000);
		...
		for(int i=0;i<ClientRules.size();i++)
		{
			...
			if(ClientRules.get(i).getText().equals("GetValue"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='GetValue']")).click();
				Thread.sleep(2000);
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("GetValue");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
	    
		String SumFormula="GetValue("+"["+"\""+"A - Training Sales.[Measures]"+"\","+" "+"\""+"Commission"+"\"])";
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='GetValue']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Calculated element check boxs are unchecked.");
		 Thread.sleep(1000);
				
		 //Rank Ascending element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='GetValue']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("GetValue text is displaying now..");
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='GetValue']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("GetValue checkbox is unchecked..");
		 log.driver.findElement(By.xpath("//div[text()='GetValue']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 ...
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("ClientRules_GetValue");
		 Thread.sleep(2000);
		...
		//Delete Report:==================
		log.driver.findElement(By.xpath("(//span[text()='ClientRules_GetValue'])[3]")).click();
		Thread.sleep(3000);
		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='ClientRules_GetValue'])[1]"))).perform();
		Thread.sleep(2000);
