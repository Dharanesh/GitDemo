...
public class TestCase_28773 extends TestUtils
{
	@Test	
	@Parameters("browser")

	public void Cockpit_DataView_Olap_Functions_ClientRules_DimSibling(String browser) throws Exception
	{
	    test =extent.createTest("TestCase_28773: Cockpit DataView Olap Functions for ClientRules_DimSibling");
		Login log = new Login();
		...
		log.createCubeReport("//div[text()='A - Training Sales']","ClientRules_DimSibling_check",false);
       ...
       try{
			for(int i=0;i<=SelectableElementvalue.size()-1;i++)
			{
				...
				if(valueofcontainerele.contains("DimSibling"))
				{
					System.out.println("DimSibling is present");
					test.info("DimSibling is present");
					
					waits.waitUntil_Elmentis_visibilityOfElement(10,"//span[text()='DimSibling']");
					log.driver.findElement(By.xpath("//span[text()='DimSibling']")).click();
					Thread.sleep(1000);
		...
		log.driver.findElement(By.xpath("//span[text()='Name:']/ancestor::div[3]/div[2]//input[1]")).sendKeys("DimSibling");
		Thread.sleep(500);
		...
		action.click();
		//string s="DimSibling( "A - Training Sales.[Time].[Time]", "1 2014",2)"
		action.sendKeys("DimSibling( \"A - Training Sales.[Time].[Time]\",\"1 2014\",2)");
		...
		for (int i =0;i<=selectble_ele.size()-1;i++) 
		{
			...
			selectable.add(aa);
			if(selectable.contains("DimSibling"))
			{
				assertTrue(true);
				System.out.println("DimSibling is available");
				
			}
			
		}
		Thread.sleep(2000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='DimSibling']/../div[1]");
		log.driver.findElement(By.xpath("//div[text()='DimSibling']/../div[1]")).click();
		Thread.sleep(1000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='DimSibling']/../div[1]");
		assertTrue(log.driver.findElement(By.xpath("//div[text()='DimSibling']/../div[1]/input[1]")).isSelected());
		System.out.println("DimSibling Checkbox is Selected in the list of selectable elements");
		...
		waits.waitUntil_Elmentis_visibilityOfElement(10,"(//div[text()='DimSibling'])[2]");
		log.driver.findElement(By.xpath("(//div[text()='DimSibling'])[2]")).click();
		Thread.sleep(1000);
		...
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::div[4]/input")).sendKeys("Sibling element of 2014 at Position 2 is");
		...
		{
			if(webElement.getText().equals("Purchase price")||webElement.getText().equals("Sibling element of 2014 at Position 2 is"))
			{
				assertTrue(true);
			}
		}
		...
		System.out.println("column with the name Sibling element of 2014 at Position 2 is");
		test.info("column with the name Sibling element of 2014 at Position 2 is");
		
		String text=log.driver.findElement(By.xpath("//div[text()='2014']/ancestor::div[4]/div/div[4]/div/div/div[2]")).getText();
		assertEquals(text,"3 2014");
