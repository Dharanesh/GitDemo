...
public class TestCase_40166 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	  System.out.println("40166---Test Task started........");
		//login to the application:==========
	  	test =extent.createTest("Test Task 40166: Test Case 28787: 14180 : Cockpit DataView Olap Functions for ClientRules_DimParent");
	  	log = new Login();
	  	...
	  	System.out.println("==Test Task 40166: Test Case 28787: 14180 : Cockpit DataView Olap Functions for ClientRules_DimParent==");
	  	Thread.sleep(3000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("ClientRules_DimParent_check");;
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//div[text()='Audi']/preceding::div[1]")).click();
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//div[text()='Cadillac']/preceding::div[1]")).click();
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//div[text()='BMW']/preceding::div[1]")).click();
		Thread.sleep(1000);
		...
		for(int i=0;i<ClientRules.size();i++)
		{
			...
			if(ClientRules.get(i).getText().equals("DimParent_40166"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='DimParent_40166']")).click();
				Thread.sleep(2000);
		...
		//Create DimParent:---(DimParentCount( "A - Training Sales.[Products].[Product]","Audi" ))
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("DimParent_40166");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
	    
		String SumFormula="DimParentCount("+"\""+"A - Training Sales.[Products].[Product]"+"\","+" "+"\""+"Audi"+"\")";
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='DimParent_40166']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Client Rule check box are unchecked.");
		 Thread.sleep(1000);
				
		 //Rank Ascending element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='DimParent_40166']")).isDisplayed());
		 Thread.sleep(2000);
		 ...
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='DimParent_40166']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("DimParent_40166 client rule is unchecked..");
		 log.driver.findElement(By.xpath("//div[text()='DimParent_40166']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("//button[@data-id='30157']")).click();
		 Thread.sleep(2000);
		 ...
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='DimParent_40166']")).isDisplayed());
		 Thread.sleep(1000);
		 System.out.println("Client Rule(DimParent_40166) is displaying as Column");
		...
		//Thread.sleep(1000);
		log.driver.findElement(By.xpath("(//div[text()='DimParent_40166']/preceding::div[1])[1]")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::input[1]")).sendKeys("DimParent_40166_Alias");
		Thread.sleep(1000);
		...
		Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='DimParent_40166_Alias']")).isDisplayed());
		Thread.sleep(1000);
		System.out.println("Client Rule(DimParent_40166) is displaying as Column");
