...
public class TestCase_40176 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	   System.out.println("40176---Test Task started........");
		//login to the application:==========
	  	test =extent.createTest("Test Task 40176:Test Case 28777: 14190 : Cockpit DataView Olap Functions for ClientRules_GetSubsetElem");
	  	log = new Login();
	  	...
	  	System.out.println("==Test Task 40176:Test Case 28777: 14190 : Cockpit DataView Olap Functions for ClientRules_GetSubsetElem==");
	  	Thread.sleep(3000);
	  ...
	  //Validate New Report window Elements:=============
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("ClientRules_GetSubsetElem_check");;
		Thread.sleep(1000);
		...
		//Select all elements from list and proceed:===
		...
		for(int i=0;i<ClientRules.size();i++)
		{
			...
			if(ClientRules.get(i).getText().equals("GetSubsetElem_40176"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='GetSubsetElem_40176']")).click();
				Thread.sleep(2000);
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("GetSubsetElem_40176");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
	    
	   // GetSubsetElem( "A - Training Sales.[Products].[Product]","Product.Manufacturer",3 )
	    
		String SumFormula="GetSubsetElem("+"\""+"A - Training Sales.[Products].[Product]"+"\","+" "+"\""+"Product.Manufacturer"+"\","+"3)";
  	...
  	//Check Syntax:============
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='GetSubsetElem_40176']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Client Rule check box are unchecked.");
		 Thread.sleep(1000);
						
		 //Client rule element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='GetSubsetElem_40176']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("GetSubsetElem_40176 client rule is displaying now..");
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='GetSubsetElem_40176']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("GetSubsetElem_40176 client rule is unchecked..");
		 log.driver.findElement(By.xpath("//div[text()='GetSubsetElem_40176']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("//button[@data-id='30157']")).click();
		 Thread.sleep(2000);
		 ...
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='GetSubsetElem_40176']")).isDisplayed());
		 Thread.sleep(1000);
		 System.out.println("Client Rule(GetSubsetElem_40176) is displaying as Column");
		...
		//Thread.sleep(1000);
		log.driver.findElement(By.xpath("(//div[text()='GetSubsetElem_40176']/preceding::div[1])[1]")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::input[1]")).sendKeys("GetSubsetElem_40176_Alias");
		Thread.sleep(1000);
		...
		Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='GetSubsetElem_40176_Alias']")).isDisplayed());
		Thread.sleep(1000);
		System.out.println("Client Rule(GetSubsetElem_40176) is displaying as Column");
		 ...
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("ClientRule_GetSubsetElem");
		 Thread.sleep(2000);
		...
		//Delete Report:==================
		log.driver.findElement(By.xpath("(//span[text()='ClientRule_GetSubsetElem'])[3]")).click();
		Thread.sleep(3000);
		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='ClientRule_GetSubsetElem'])[1]"))).perform();
		Thread.sleep(2000);
