...
public class TestCase_40342 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	    System.out.println("40342---Test Task started........");
		//login to the application:==========
	  	test =extent.createTest("Test Task 40342: Test Case 28762: 14200 : Cockpit DataView Olap Functions for ClientRules_CalcSDL");
	  	log = new Login();
	  	...
	  	System.out.println("==Test Task 40342: Test Case 28762: 14200 : Cockpit DataView Olap Functions for ClientRules_CalcSDL==");
	  	Thread.sleep(3000);   
	  ...
	  //Validate New Report window Elements:=============
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("ClientRules_CalcSDL_check");;
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		System.out.println("New Report is created for  client rule ClientRules_CalcSDL_check.");
		Thread.sleep(3000);
		...
		for(int i=0;i<ClientRules.size();i++)
		{
			...
			if(ClientRules.get(i).getText().equals("Muster - Exoten_40342"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='Muster - Exoten_40342']")).click();
				Thread.sleep(2000);
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name']/following::input[1]")).sendKeys("Muster - Exoten_40342");
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='Muster - Exoten_40342']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Client Rule check box are unchecked.");
		 Thread.sleep(1000);
				
		 //Rank Ascending element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='Muster - Exoten_40342']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("Muster - Exoten_40342 client rule is displaying now..");
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='Muster - Exoten_40342']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Muster - Exoten_40342 client rule is unchecked..");
		 Thread.sleep(1000);
		 log.driver.findElement(By.xpath("//div[text()='Muster - Exoten_40342']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		...
		for(int i=0;i<ClientRules2.size();i++)
		{
			...
			if(ClientRules2.get(i).getText().equals("CalcSDL_40342"))
			{
				System.out.println("Client Rule Found");
				log.driver.findElement(By.xpath("//span[text()='CalcSDL_40342']")).click();
				Thread.sleep(2000);
				log.driver.findElement(By.xpath("//button[text()='Delete']")).click();
				Thread.sleep(2000);
				log.driver.findElement(By.xpath("//input[@value='Yes']")).click();
		...
		//Enter the name:==
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).sendKeys("CalcSDL_40342");
	    log.driver.findElement(By.xpath("//span[text()='Name:']/following::input[1]")).click();
	    Thread.sleep(1000);
	  
		String SumFormula="CalcSDL("+"\""+"A - Training Sales.[Products].[Product]"+"\","+"\""+"Muster - Exoten_40342"+"\","+1+")";
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='CalcSDL_40342']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Client Rule check box are unchecked.");
		 Thread.sleep(1000);
						
		 //Rank Ascending element should be visible:==================
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='CalcSDL_40342']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("CalcSDL_40342 client rule is displaying now..");
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='CalcSDL_40342']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("CalcSDL_40342 client rule is unchecked..");
		 log.driver.findElement(By.xpath("//div[text()='CalcSDL_40342']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("//button[@data-id='30157']")).click();
		 Thread.sleep(2000);
		 
		 //Uncheck the purchase price:========
		 log.driver.findElement(By.xpath("(//div[text()='Purchase price']/preceding::div[1])[1]")).click();
		 Thread.sleep(1000);
		...
		Thread.sleep(1000);
		log.driver.findElement(By.xpath("//span[text()='Alias:']/following::input[1]")).sendKeys("CalcSDL_40342_Alias");
		Thread.sleep(1000);
		...
		Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='CalcSDL_40342_Alias']")).isDisplayed());
		Thread.sleep(1000);
		System.out.println("Client Rule(CalcSDL_40342_Alias) is displaying as Column");
 		
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("(//div[text()='769,034.00'])[1]")).isDisplayed());
		 Thread.sleep(1000);
		 System.out.println("Displaying value properly.");
		 Thread.sleep(1000);
		...
		//Save As The Report:=====
		 ...
		 Thread.sleep(2000);
		 log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("ClientRules_CalcSDL");
		 Thread.sleep(2000);
		...
		//Delete Report:==================
		log.driver.findElement(By.xpath("(//span[text()='ClientRules_CalcSDL'])[3]")).click();
		Thread.sleep(3000);
		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='ClientRules_CalcSDL'])[1]"))).perform();
		Thread.sleep(2000);
