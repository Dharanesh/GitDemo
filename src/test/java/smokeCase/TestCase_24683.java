...
public class TestCase_24683 extends TestUtils {
	@Test
	@Parameters("browser")
	public void Testcase_for_Changing_ownerShip_to_different_user(String browser) throws Exception
	{
		...
		test =extent.createTest("TestCase_24683 for Changing the ownership From Admin to new user( should  be Group member of Administrator)");
		Login log = new Login();
		...
		Thread.sleep(200);
		assertEquals(log.driver.findElement(By.xpath("(//tr[@class='lvitem']/td[@colspan='2'])[2]")).getText(), "Full Control");
		Thread.sleep(200);
		...
		log.driver.findElement(By.id("yesbutton")).click();
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("(//div[@style='height:26px;'])[1]")).click();
		Thread.sleep(2000);
		waits.waituUnitil_Element_Clickable(10,"(//input[@class='w20_modal-footer-button k-primary k-button'])[1]");
		WebElement element = log.driver.findElement(By.xpath("//*[text()='Test_C11']"));
		((JavascriptExecutor) log.driver).executeScript("arguments[0].scrollIntoView(true);", element);
		element.click();
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("(//input[@class='w20_modal-footer-button k-primary k-button'])[1]")).click();
		Thread.sleep(2000);
		log.driver.findElement(By.id("yesbutton")).click();
		Thread.sleep(2000);
		...
		waits.waituUnitil_Element_Clickable(10,"(//input[@class='w20_modal-footer-button k-primary k-button'])[1]");
		Thread.sleep(2000);
		WebElement element1 = log.driver.findElement(By.xpath("//*[text()='Test_C11']"));
		((JavascriptExecutor)log.driver).executeScript("arguments[0].scrollIntoView(true);", element1);
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("//td[text()='Test_C11']/../td[1]")).click();
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("//td[text()='Full Control']/../td[1]")).click();
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("(//input[@value='OK'])[1]")).click();
		Thread.sleep(2000);
		assertEquals(log.driver.findElement(By.xpath("(//tr[@class='lvitem']/td[@colspan='2'])[1]")).getText(), "Test_C11");
		...
		log.driver.findElement(By.xpath("//span[text()='User Name:']/following::input[1]")).sendKeys("Test_C11");
		...
		waits.waituUnitil_Element_Clickable(10,"//span[@title='Show Menu']");
		Thread.sleep(5000);
		log.driver.findElement(By.id("hamburger_btn")).click();	
		Thread.sleep(2000);
		waits.waitUntil_Elmentis_visibilityOfElement(10,"//div[text()='Repository']");
		log.driver.findElement(By.xpath("//div[text()='Repository']")).click();
		...
		Thread.sleep(1000);
		assertEquals(log.driver.findElement(By.xpath("(//tr[@class='lvitem']/td[@colspan='2'])[1]")).getText(), "Test_C11");
		assertEquals(log.driver.findElement(By.xpath("(//td[text()='Test_C11'])[2]/following::td[1]")).getText(), "Full Control");
		log.driver.findElement(By.id("okbutton")).click();		
		Thread.sleep(2000);
		...
		waits.waituUnitil_Element_Clickable(20,"//*[contains(text(),'Login')]");
		log.driver.findElement(By.xpath("//*[contains(text(),'Login')]")).click();
		waits.waituUnitil_Element_Clickable(20,"//input[@value='OK']");		Thread.sleep(2000);
