...
public class TestCase_24482 extends TestUtils
{
	@Test
	@Parameters("browser")
	public void Testcase_verify_creating_Title_Layout_component(String browser) throws Exception
	{
		...
		test =extent.createTest("TestCase_24482: Web_Testcase to verify EXCEL Export for functionality of <Analytical Visualization Gradient_New>");
		Login log = new Login();
