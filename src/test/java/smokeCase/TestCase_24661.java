...
public class TestCase_24661 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	   System.out.println("24661---Testcase started........");
	  	//login to the application:==========
	  	test =extent.createTest("Test Case 24661: Testcase for denying Filter selection Permissions and granting edit cube dataview Permission for paticular report (sales by country)");
	  	log = new Login();
	  	...
	  	System.out.println("Test Case 24661: Testcase for denying Filter selection Permissions and granting edit cube dataview Permission for paticular report (sales by country)===================");
	  	Utils.waitForElement("");
	  	Thread.sleep(3000);
	  //Adding Training User Permission:===============
		...
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("//td[text()='Edit Cube DataView']/preceding::td[2]")).click();
		Thread.sleep(2000);
		...
		log.driver.findElement(By.xpath("//button[text()='Add Permission...']")).click();
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("//td[text()='Change Filter Selections']/preceding::td[2]")).click();
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("//td[text()='Training']/preceding::td[2]")).click();
		Thread.sleep(2000);
		//Click Deny button:===========
		...
		//Assert.assertEquals(PermissionVal.size(),3);
		System.out.println("List of permission is added as expected="+PermissionVal.size());
		Thread.sleep(2000);
		...
		log.driver.findElement(By.xpath("//span[text()='Sales by country']")).click();
  		...
  		//Take Count After open:===========
  	  	...
  	  	//FilterBox Check:=================
  	    Assert.assertEquals(log.driver.findElement(By.xpath("(//input[@class='k-input dropdowninput' and @readonly])[1]")).isDisplayed(), true);
  	  	
  		List<WebElement> FilterBox=log.driver.findElements(By.xpath("//input[@class='k-input dropdowninput' and @readonly]"));
  		Assert.assertEquals(FilterBox.size(),4);
  		System.out.println("Filter Boxes are readonly as per assign permission.");
  		
  		//Logout:===
  		//log.driver.close();
  		//Change the Permission to default:==================
	 	//Remove the Permissions from Admin user:===========
  		log.driver.findElement(By.xpath("//span[@id='hamburger_btn']")).click();
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("//div[text()='Connect to Server']")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
  		...
  		Thread.sleep(2000);
  		log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("Testcase_24661");
  		Thread.sleep(2000);
  		...
  		//Delete Report:==================
  		log.driver.findElement(By.xpath("(//*[text()='Testcase_24661'])[3]")).click();
  		Thread.sleep(3000);
//  		log.driver.findElement(By.xpath("(//span[text()='Testcase_24661'])[1]/preceding::input[1]")).click();
//  		Thread.sleep(2000);
  		Actions act=new Actions(log.driver);
  		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='Testcase_24661'])[1]"))).perform();
  		Thread.sleep(2000);
