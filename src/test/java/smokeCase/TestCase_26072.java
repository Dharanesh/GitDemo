...
public class TestCase_26072 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  @Test
  @Parameters("browser")
  public void Tc_PercentageStack(String browser) throws Exception  
  {
	    System.out.println("26072---Testcase started........");
	  	//login to the application:==========
	  	test =extent.createTest("Test Case 26072: Elements_PERCENTAGESTACK");
	  	log = new Login();
	  	...
	  	System.out.println("Test Case 26072: Web Cockpit Calculated Elements_PERCENTAGE STACK===================");
	  	Utils.waitForElement("");
	  	Thread.sleep(3000);
       ...
       // act.click(e2).sendKeys("Calculated elements", Keys.ENTER).build().perform();
        ...
        //Check For Mashup Checkbox should be unselect:=====================
  	    Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='PERCENTAGE STACKED']/preceding::div[1]")).isSelected());
  	    Thread.sleep(1000);
  	    System.out.println("Calculated element check boxs are unchecked.");
  	    Thread.sleep(1000);
  		
  		 //Rank Ascending element should be visible:==================
  		 /*Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='PERCENTAGE STACKED']")).isDisplayed());
  		 Thread.sleep(2000);
  		 System.out.println("PERCENTAGE STACKED text is displaying now..");*/
  		
  		 //Checkbox should be uncheck and select the checkbox:=============
  		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='PERCENTAGE STACKED']/preceding::div[1]")).isSelected());
  		 Thread.sleep(1000);
  		 System.out.println("PERCENTAGE STACKED checkbox is unchecked..");
  		 log.driver.findElement(By.xpath("//div[text()='PERCENTAGE STACKED']/preceding::div[1]")).click();
  		 Thread.sleep(2000);
  		 ...
  		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='PERCENTAGE STACKED']")).isDisplayed());
  	 	 Thread.sleep(1000);
  		 System.out.println("PERCENTAGE STACKED is added in Table.");
  		 Thread.sleep(1000);
        ...
        //  act2.click(e3).sendKeys("Calculated elements", Keys.ENTER).build().perform();
  		...
  		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='PERCENTAGE STACKED']")).isDisplayed());
  		 ...
  		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='PERCENTAGE STACKED']")).isDisplayed());
  	 	 Thread.sleep(1000);
  		 System.out.println("PERCENTAGE STACKED is added in Table As Column.");
  		 Thread.sleep(1000);
  		
  	  	//Validate:===============
  		 String PStackedValue=log.driver.findElement(By.xpath("//div[text()='PERCENTAGE STACKED']/following::div[@id='0/5']")).getText();
  		 System.out.println("Value is:->"+PStackedValue);
  		 
  		 Assert.assertEquals(PStackedValue,"100.00 %");
  	 	 Thread.sleep(1000);
  		 System.out.println("Percentage stacked value is applyed on the Report.");
  		...
  		Thread.sleep(2000);
  		log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("Cockpit Calculated Elements_PERCENTAGE STACKED");
  		Thread.sleep(2000);
  		...
  		//Delete Report:==================
  		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_PERCENTAGE STACKED'])[3]")).click();
  		Thread.sleep(3000);
  		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_PERCENTAGE STACKED'])[1]/preceding::input[1]")).click();
  		Thread.sleep(2000);
  		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_PERCENTAGE STACKED'])[1]"))).perform();
  		Thread.sleep(2000);
