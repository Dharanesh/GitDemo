...
public class TestCase_24659 extends TestUtils
{
	@Test	
	@Parameters("browser")
	public void Testcase_to_verifying_assigned_permission_for_particular_user_for_sales_by_country_report_in_Effective_permission_window(String browser) throws Exception
	{
		...
		assertEquals(log.driver.findElement(By.xpath("//td[text()='Trainingsuser']/preceding::td[1]")).getCssValue("font-weight"), "700");
