...
public class TestCase_26067 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  @Test
  @Parameters("browser")
  public void Testcase_26067(String browser) throws Exception  
  {
	   System.out.println("26067---Testcase started........");
	  	//login to the application:==========
	  	test =extent.createTest("Test Case 26067:Web Cockpit Calculated Elements_RANK ASCENDING");
	  	log = new Login();
	  	...
	  	System.out.println("Test Case 26067:Web Cockpit Calculated Elements_RANK ASCENDING===================");
	  	Utils.waitForElement("");
	  	Thread.sleep(3000);
	    ...
	    //Open Sales By Country Report:====================
	  	...
	  	try
	  	{
	  		...
	  		{
	  			System.out.println("Report is opened now");
	  		}
		...
		//Dataview Designer window is diaplaying:===================
        ...
        //Check For Mashup Checkbox should be unselect:=====================
  	    Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='RANK ASCENDING']/preceding::div[1]")).isSelected());
  	    Thread.sleep(1000);
  	    System.out.println("Calculated element check boxs are unchecked.");
  	    Thread.sleep(1000);
  		
  		 //Rank Ascending element should be visible:==================
  		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='RANK ASCENDING']")).isDisplayed());
  		 Thread.sleep(2000);
  		 System.out.println("RANK ASCENDING text is displaying now..");*/
  		
  		 //Checkbox should be uncheck and select the checkbox:=============
  		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='RANK ASCENDING']/preceding::div[1]")).isSelected());
  		 Thread.sleep(1000);
  		 System.out.println("RANK ASCENDING checkbox is unchecked..");
  		 log.driver.findElement(By.xpath("//div[text()='RANK ASCENDING']/preceding::div[1]")).click();
  		 Thread.sleep(2000);
  		 ...
  		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='RANK ASCENDING']")).isDisplayed());
  	 	 Thread.sleep(1000);
  		 System.out.println("RANK ASCENDING is added in Table.");
  		 Thread.sleep(1000);
  		...
  		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='RANK ASCENDING']")).isDisplayed());
  		 ...
  		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='RANK ASCENDING']")).isDisplayed());
  	 	 Thread.sleep(1000);
  		 System.out.println("RANK ASCENDING is added in Table As Column.");
  		 Thread.sleep(1000);
  		...
  		Thread.sleep(2000);
  		log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("Cockpit Calculated Elements_RANK ASCENDING");
  		Thread.sleep(2000);
  		...
  		//Delete Report:==================
  		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_RANK ASCENDING'])[3]")).click();
  		Thread.sleep(3000);
  		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_RANK ASCENDING'])[1]/preceding::input[1]")).click();
  		Thread.sleep(3000);
  		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_RANK ASCENDING'])[1]"))).perform();
  		Thread.sleep(2000);
