...
public class TestCase_26069 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	     System.out.println("26069---Testcase started........");
	  	//login to the application:==========
	  	test =extent.createTest("Test Case 26069: Web Cockpit Calculated Elements_MEDIAN");
	  	log = new Login();
	  	...
	  	System.out.println("Test Case 26069: Web Cockpit Calculated Elements_MEDIAN===================");
	  	Utils.waitForElement("");
	  	Thread.sleep(3000);
	  ...
	  //Try to Open any Report:======================================
	          ...
	          //Check For Mashup Checkbox should be unselect:=====================
	  	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='MEDIAN']/preceding::div[1]")).isSelected());
	  		 Thread.sleep(1000);
	  		 System.out.println("Calculated element check boxs are unchecked.");
	  		 Thread.sleep(1000);
	  		
	  		 //Rank Ascending element should be visible:==================
	  		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='MEDIAN']")).isDisplayed());
	  		 Thread.sleep(2000);
	  		 System.out.println("MEDIAN text is displaying now..");*/
	  		
	  		 //Checkbox should be uncheck and select the checkbox:=============
	  		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='MEDIAN']/preceding::div[1]")).isSelected());
	  		 Thread.sleep(1000);
	  		 System.out.println("MEDIAN checkbox is unchecked..");
	  		 log.driver.findElement(By.xpath("//div[text()='MEDIAN']/preceding::div[1]")).click();
	  		 Thread.sleep(2000);
	  		 ...
	  		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='MEDIAN']")).isDisplayed());
	  	 	 Thread.sleep(1000);
	  		 System.out.println("MEDIAN is added in Table.");
	  		 Thread.sleep(1000);
	         ...
	         // act2.click(e3).sendKeys("Calculated elements", Keys.ENTER).build().perform();
	  		...
	  		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='MEDIAN']")).isDisplayed());
	  		 ...
	  		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='MEDIAN']")).isDisplayed());
	  	 	 Thread.sleep(1000);
	  		 System.out.println("MEDIAN is added in Table As Column.");
	  		 Thread.sleep(1000);
	  		...
	  		Thread.sleep(2000);
	  		log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("Cockpit Calculated Elements_MEDIAN");
	  		Thread.sleep(2000);
	  		...
	  		//Delete Report:==================
	  		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_MEDIAN'])[3]")).click();
	  		Thread.sleep(3000);
	  		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_MEDIAN'])[1]/preceding::input[1]")).click();
	  		Thread.sleep(2000);
	  		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_MEDIAN'])[1]"))).perform();
	  		Thread.sleep(2000);
