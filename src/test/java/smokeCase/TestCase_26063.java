...
public class TestCase_26063 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  {
	   System.out.println("26063---Testcase started........");
	  	//login to the application:==========
	  	test =extent.createTest("Test Case 26063:Web Cockpit Calculated Elements_QUOTIENT(X/Y)");
	  	log = new Login();
	  	...
	  	System.out.println("Test Case 26063: Web Cockpit Calculated Elements_QUOTIENT(X/Y)===================");
	  	Utils.waitForElement("");
       ...
       // act.click(e2).sendKeys("Calculated elements", Keys.ENTER).build().perform();
        ...
        //Check For Mashup Checkbox should be unselect:=====================
	     Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='QUOTIENT (X/Y)']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("Calculated element check boxs are unchecked.");
		 Thread.sleep(2000);
		
		 //Rank Ascending element should be visible:==================
		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='QUOTIENT (X/Y)']")).isDisplayed());
		 Thread.sleep(2000);
		 System.out.println("QUOTIENT(X/Y) text is displaying now..");*/
		
		 //Checkbox should be uncheck and select the checkbox:=============
		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='QUOTIENT (X/Y)']/preceding::div[1]")).isSelected());
		 Thread.sleep(1000);
		 System.out.println("QUOTIENT(X/Y) checkbox is unchecked..");
		 log.driver.findElement(By.xpath("//div[text()='QUOTIENT (X/Y)']/preceding::div[1]")).click();
		 Thread.sleep(2000);
		 ...
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='QUOTIENT (X/Y)']")).isDisplayed());
	 	 Thread.sleep(1000);
		 System.out.println("QUOTIENT (X/Y) is added in Table.");
		 Thread.sleep(1000);
       ...
       // act2.click(e3).sendKeys("Calculated elements", Keys.ENTER).build().perform();
		...
		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='QUOTIENT (X/Y)']")).isDisplayed());
		 ...
		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='QUOTIENT (X/Y)']")).isDisplayed());
	 	 Thread.sleep(1000);
		 System.out.println("QUOTIENT (X/Y) is added in Table As Column.");
		 Thread.sleep(1000);
		...
		Thread.sleep(2000);
		log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("Cockpit Calculated Elements_QUOTIENT(X/Y)");
		Thread.sleep(2000);
		...
		//Delete Report:==================
		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_QUOTIENT(X/Y)'])[3]")).click();
		Thread.sleep(3000);
		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_QUOTIENT(X/Y)'])[1]/preceding::input[1]")).click();
		Thread.sleep(3000);
		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_QUOTIENT(X/Y)'])[1]"))).perform();
		Thread.sleep(2000);
