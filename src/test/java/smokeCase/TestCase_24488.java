...
public class TestCase_24488 extends TestUtils {
	...
	public void Web_Testcase_verify_functionality_Analytical_Visualization_Gradient_Edit(String browser) throws Exception
	{
		...
		test =extent.createTest("TestCase_24488_Web_Testcase to verify EXCEL Export for functionality of <Analytical Visualization Minichart_Bar_New>");
		Login log = new Login();
