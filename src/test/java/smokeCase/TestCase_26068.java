...
public class TestCase_26068 extends TestUtils
{
	Login log = null;
	Waits waits =null;
	Utils Utils = null;
  ...
  @Test
  @Parameters("browser")
  public void Testcase_26068(String browser) throws Exception  
  {
	  System.out.println("26068---Testcase started........");
	  	//login to the application:==========
	  	test =extent.createTest("Test Case 26068: Rank Descending");
	  	log = new Login();
	  	...
	  	System.out.println("Test Case 26068:Web Cockpit Calculated Elements_RANK Descending===================");
	  	Utils.waitForElement("");
	  	Thread.sleep(3000);
        ...
        //Check For Mashup Checkbox should be unselect:=====================
  	    Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='RANK DESCENDING']/preceding::div[1]")).isSelected());
  	    Thread.sleep(1000);
  	    System.out.println("Calculated element check boxs are unchecked.");
  	    Thread.sleep(1000);
  		
  		 //Rank Ascending element should be visible:==================
  		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='RANK DESCENDING']")).isDisplayed());
  		 Thread.sleep(2000);
  		 System.out.println("RANK DESCENDING text is displaying now..");*/
  		
  		 //Checkbox should be uncheck and select the checkbox:=============
  		 Assert.assertEquals(false,log.driver.findElement(By.xpath("//div[text()='RANK DESCENDING']/preceding::div[1]")).isSelected());
  		 Thread.sleep(1000);
  		 System.out.println("RANK DESCENDING checkbox is unchecked..");
  		 log.driver.findElement(By.xpath("//div[text()='RANK DESCENDING']/preceding::div[1]")).click();
  		 Thread.sleep(2000);
  		 ...
  		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='RANK DESCENDING']")).isDisplayed());
  	 	 Thread.sleep(1000);
  		 System.out.println("RANK DESCENDING is added in Table.");
  		 Thread.sleep(1000);
         ...
         // act2.click(e3).sendKeys("Calculated elements", Keys.ENTER).build().perform();
  		...
  		/* Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='RANK DESCENDING']")).isDisplayed());
  		 ...
  		 Assert.assertEquals(true,log.driver.findElement(By.xpath("//div[text()='RANK DESCENDING']")).isDisplayed());
  	 	 Thread.sleep(1000);
  		 System.out.println("RANK DESCENDING is added in Table As Column.");
  		 Thread.sleep(1000);
  		...
  		Thread.sleep(2000);
  		log.driver.findElement(By.xpath("(//span[text()='Name'])[1]/following::input[1]")).sendKeys("Cockpit Calculated Elements_RANK DESCENDING");
  		Thread.sleep(2000);
  		...
  		//Delete Report:==================
  		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_RANK DESCENDING'])[3]")).click();
  		Thread.sleep(3000);
  		log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_RANK DESCENDING'])[1]/preceding::input[1]")).click();
  		Thread.sleep(2000);
  		act.contextClick(log.driver.findElement(By.xpath("(//span[text()='Cockpit Calculated Elements_RANK DESCENDING'])[1]"))).perform();
  		Thread.sleep(2000);
